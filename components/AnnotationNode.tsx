...
const AnnotationNode = ({ id, data, selected }: NodeProps<AnnotationNodeData>) => {
  ...
  return (
    <div
      className={`group relative w-48 min-h-[100px] bg-yellow-100 rounded-lg border-2 shadow-[3px_3px_0px_0px_rgba(161,98,7,0.3)] transition-all duration-200 flex flex-col ${
        selected ? 'border-yellow-500 ring-2 ring-yellow-500/30' : 'border-yellow-400'
      }`}
    >
